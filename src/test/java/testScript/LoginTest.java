...
public class LoginTest extends Base{
	...
	@Test(dataProvider="LoginProvider", retryAnalyzer=retry.Retry.class, description="Verify that the user is able to login to the Supermarket app with Valid Username and Password",groups= {"Regression"})
	...
	@Test(retryAnalyzer=retry.Retry.class,description="Verify that the user is able to login to the Supermarket app with Invalid Username",groups= {"Smoke"})
...
public void verifyTheUserIsAbleToLoginUsingInvalidUsername() throws IOException
{
	...
	assertTrue(isInvalidAlertDisplayed,"Home Page is Launched with Invalid Username and valid password");
	...
	public void verifyTheUserIsAbleToLoginUsingInvalidPassword() throws IOException
	{
		...
		loginpage.clickSigninButton();
		boolean isInvalidAlertDisplayed=loginpage.isInvalidLoginAlertDisplayed();
		assertTrue(isInvalidAlertDisplayed,"Home Page is Launched with valid username and Invalid Password");
	}
	...
	public void verifyTheUserIsAbleToLoginUsingInvalidUsernameAndPassword() throws IOException
	{
		...
		assertTrue(isInvalidAlertDisplayed,"Home Page is Launched with Invalid Username and Invalid Password");
	}
	
	@DataProvider(name = "LoginProvider")
	public Object[][] getDataFromTestData() throws IOException {//returns an object array
		return new Object[][] {{
			ExcelUtility.getStringData(1, 0, "LoginPage"), ExcelUtility.getStringData(1, 1, "LoginPage") },};//value is passed as object array
